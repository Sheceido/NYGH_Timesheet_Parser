import type {
    ...
    ShiftCategory as ShiftCategoryType,
    AuditCode as AuditCodeType,
    RowSemanticKind as RowSemanticKindType
} from "../types.js";

// Use the imported types with `as const` to preserve literal values
export const AppMode = Object.freeze({
    TIMESHEET: "#timesheetMakerMode",
    SCHEDULE_CHECK: "#scheduleCheckerMode",
} as const) satisfies Record<string, AppModeType>;
...
export const shiftTimeMap: Map<string, string> = new Map()
...
export const categoryMap: Map<string, ShiftCategoryType> = new Map()
...
export const locationMap: Map<string, string> = new Map()
    .set("BDC / BREAST", "BDC")
...
// Define a type for the nested color objects
type ColorSwatchValue = Record<string, string>;

export const cellColorSwatch: Map<string, ColorSwatchValue> = new Map()
    .set("BDC", {
        "07:30-15:30": "#FFD9FF",
        "08:00-16:00": "#FFD9FF",
        "09:00-17:00": "#FFD9FF",
...
export const AuditEntryElementRefs: Record<string, string> = Object.freeze({
...
export const AuditDescriptors: Record<AuditCodeType, { icon: string; header: string }> = {
    ...
    [AuditCode.DUPLICATE_EMPLOYEE]: { icon: "⚠️", header: "Duplicate Shifts" },
...
export const RowSemanticKind = Object.freeze({
    ...
    STATUS: "STATUS",
} as const) satisfies Record<string, RowSemanticKindType>;
...
export const DAYS_OF_THE_WEEK = ["Sat", "Sun", "Mon", "Tues", "Wed", "Thurs", "Fri", "Sat", "Sun", "Mon", "Tues", "Wed", "Thurs", "Fri"] as const;

export const WEEKEND_LOCATIONS: readonly string[] = ["GENERAL"];

export const WEEKEND_SHIFT_TIMES: readonly string[] = [
    "08:00-16:00",
    "08:30-16:30",
    "10:00-18:00",
    "16:00-24:00",
...
export const WEEKDAY_SHIFT_TIMES: readonly string[] = [
    "07:00-15:00",
    "07:30-15:30",
    "08:00-16:00",
    "08:30-16:30",
...
export const WEEKEND_DAYS: readonly number[] = [1, 2, 8, 9];
export const FRIDAYS: readonly number[] = [7, 14];
export const THURSDAYS: readonly number[] = [6, 13];

/** DEPRECATING CONSTANTS */
export const DEFINED_SHIFTS_SET: ReadonlySet<string> = new Set([
    "07:00-15:00",
    "07:30-15:30",
    "08:00-16:00",
    "08:30-16:30",
...
export const WARNING_COLORS: WarningColors = {
    red: "#FF0000",
    lightRed: "#FACDCD",
    lightYellow: "#FFFAC7",
...
type NamedWarningColors = {
    duplicate: string;
    unavailable: string;
    evening: string;
};

export const NAMED_WARNING_COLORS: NamedWarningColors = {
    duplicate: "#FFF075",
    unavailable: "#FACDCD",
    evening: "#80BFF2",
};
